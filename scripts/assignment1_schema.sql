...
CREATE TABLE `user` (
  ...
  `is_active` tinyint(4) NOT NULL COMMENT 'Indicates if this User Account is Active or not',
  `login_attempts` tinyint(4) NOT NULL COMMENT 'Number of consecutive failed Login Attempts'
