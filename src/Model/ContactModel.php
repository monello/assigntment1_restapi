...
//        $rowCount = $query->rowCount();
//        if($rowCount === 0) {
//            throw new ContactException("User record not found");
//        }
//        return $rowCount;
//    }
//
...
//    {
//        if (!($id ?? false) && $id !== 0) {
//            throw new ContactException("User Id is required for an existing user");
//        }
//        // Must be an integer > 0
//        if (!filter_var($id, FILTER_VALIDATE_INT, ["options" => ["min_range"=>1]])) {
//            throw new ContactException("User Id is invalid");
//        }
//        return (int) $id;
//    }
...
//    {
//        if (!($username ?? false)) {
//            throw new ContactException("Username is required");
//        }
//        $username = filter_var($username, FILTER_SANITIZE_STRING);
//        $username = trim($username);
//        if (strlen($username) < 4 || strlen($username) > 100) {
//            throw new ContactException("Username is not a valid length");
//        }
//        return $username;
//    }
...
//            throw new ContactException("Not a valid email");
//        }
//        return $email;
//    }
...
//    {
//        if (!($password ?? false)) {
//            throw new ContactException("Password is required");
//        }
//        // Don't trim the password, rather inform the user of white-space
//        if (preg_match('/[\s\t]/', $password)) {
//            throw new ContactException("Password should not contain spaces.");
//        }
...
//            throw new ContactException("Password should be at least 6 characters in length and should include at least one upper case letter, one number, and one special character.");
//        }
//        return $password;
//    }
...
//    {
//        if (!($name ?? false)) {
//            throw new ContactException("First name and Last Name are both required");
//        }
//        $name = trim($name);
...
//            throw new ContactException("First name or Last Name is invalid");
//        }
//        return $name;
//    }
...
//            throw new ContactException("Date of Birth is required");
//        }
//
...
//            throw new ContactException("Not a valid date");
//        }
//
...
//            throw new ContactException("Date of birth is not in a valid date range");
//        }
//
...
//                throw new ContactException("Invalid Gender value provided");
//            }
//        }
//        return $gender;
//    }
...
//    {
//        if (!($country_id ?? false)) {
//            throw new ContactException("Country is required");
//        }
//        // Must be an integer > 0
//        if (!filter_var($country_id, FILTER_VALIDATE_INT, array("options" => array("min_range"=>1)))) {
//            throw new ContactException("Country provided is invalid");
//        }
//        return $country_id;
//    }
...
//            throw new ContactException("At least one Phone Number is required");
//        }
...
//            throw new ContactException("One Phone Number must be set to the Primary number");
//        } elseif ($primaryNumberCount > 1) {
//            throw new ContactException("Only one Phone Number must be set to the Primary number");
//        } else {
//            return $cleanNumbers;
//        }
//    }
...
//            throw new ContactException("Country Code is required for all Phone Numbers");
//        }
...
//            throw new ContactException("Phone Number, Country Code is invalid");
//        }
//
//        // Number
//        // ------------
//        if (!($phone_number->number ?? false)) {
//            throw new ContactException("Number is required for all Phone Numbers");
//        }
...
//            throw new ContactException("Phone Number, Number is invalid");
//        }
//
//        // Number Type
//        // ------------
//        if (!($phone_number->type ?? false) && $phone_number->type !== 0) {
//            throw new ContactException("Number-Type is required for all Phone Numbers");
//        }
//        if (!filter_var($phone_number->type, FILTER_VALIDATE_INT, ["options" => ["min_range"=>1,"max_range"=>3]])) {
//            throw new ContactException("Phone Number, Number-Type is invalid");
//        }
//
//        // Is Primary Flag
//        // ---------------
//        if (!isset($phone_number->is_primary)) {
//            throw new ContactException("Is Primary option for Phone number may not be blank");
//        }
//        if ($phone_number->is_primary !== true && $phone_number->is_primary !== false) {
//            throw new ContactException("Is Primary option for Phone number is invalid (type)");
//        }
//
//        return $phone_number;
//
